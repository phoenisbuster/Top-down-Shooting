...
public class Controller : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (!LockControl)
        {
            ...
            // var turnCamVertical = Input.GetAxis("Mouse X");
            // turnCamVertical = turnCamVertical * MouseSensitivity;
            // m_HorizontalAngle = Mathf.Clamp(turnCamVertical + m_HorizontalAngle, -360.0f, 360.0f);
            // if (m_HorizontalAngle > 360) m_HorizontalAngle -= 360.0f;
            // if (m_HorizontalAngle < 0) m_HorizontalAngle += 360.0f;
            // currentAngles = CameraPosition.transform.localEulerAngles;
            // currentAngles.z = m_HorizontalAngle;
            // CameraPosition.transform.localEulerAngles = currentAngles;

            // Camera look up/down
            var turnCam = -Input.GetAxis("Mouse Y") * MouseSensitivity;
